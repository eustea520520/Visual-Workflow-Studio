...
signals:
    ...
    void workflowRenameRequested(const QString& workflowId, const QString& workflowName);
    void workflowAddAsSubsystemRequested(const QString& workflowId, const QString& workflowName);
